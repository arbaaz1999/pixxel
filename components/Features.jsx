...
const FeaturesCard = ({ icon, title, description, delay = 0 }) => {
    ...
    return (
        <div ref={ref}
            className={`backdrop-blur-lg bg-white/5 border-white/10 rounded-2xl p-8 transition-all duration-700 cursor-pointer ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"} hover:transform hover:scale-105 hover:rotate-1 hover:shadow-2xl`}
