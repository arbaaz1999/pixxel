...
import useInterfaceObserver from '@/hooks/useIntersectionObserver'
...
const PricingCard = ({
    ...
    const handlePopup = async () => {
        ...
        try {
            if (window.Clerk && window.Clerk.__internal_openCheckout && isSignedIn) {
    ...
    return (
        <div ref={ref}
            className={`${isHovered ? "transform scale-115 rotate-1 z-10" : ""
                }relative backdrop-blur-lg border rounded-3xl p-8 transition-all duration-700 cursor-pointer ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"} ${featured ? "bg-gradient-to-b from-blue-500/20 to-purple-600/20 border-blue-400/50 scale-105" : "bg-white/5 border-white/10"}`}
...
const Pricing = () => {
    const plans = [
        ...
        },
        {
            ...
            featured: true,
            planId: "cplan_31bHg6RsMgKexMTTiExYGULniQ8",
    ...
    return (
        <section className='py-20' id="pricing">
            <div className="max-w-6xl ms-auto px-6">
