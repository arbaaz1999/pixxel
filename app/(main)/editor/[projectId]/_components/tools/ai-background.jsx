...
export default function AIBackground({ project }) {
    ...
    const handleBackgroundRemoval = async () => {
        ...
        try {
            ...
            const bgRemoveUrl = currentImageUrl.includes("ik.imagekit.io") ? `${currentImageUrl.split("?")[0]}?tr=e-bgremove` : currentImageUrl

            const processedImage = await FabricImage.fromURL(bgRemoveUrl, {
    ...
    const handleColorBackground = () => {
        ...
        canvasEditor.requestRenderAll(); // Re-render to show the changes
    }
